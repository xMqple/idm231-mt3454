...
// /* Help Modal Start */
// const open = document.getElementById ('open');
// const help_modal_cont = document.getElementById ('help_modal_cont');
// const close = document.getElementById ('close');

// open.addEventListener ('click', () => {
//   help_modal_cont.classList.add ('show');
// });

// close.addEventListener ('click', () => {
//   help_modal_cont.classList.remove ('show');
// }); 

// /* Breath of the Wild Characters Custom Modals */
// const modal = document.querySelector("modal");
// const open_btn = document.querySelectorAll(".open-btn");
// const close_modal = document.querySelector(".close-btn");

// const modal_title = modal.querySelector("h1");
// const modal_content = modal.querySelectorAll("p");
// const modal_img = modal.querySelector(".modal-img");
// const modal_date = modal.querySelector("h3"); 
...
//       let content = "Default content paragraph 1";
//       let image_link = "default-img-url.png";
...
//       if (button.id === "Daruk") {
//           title = "Daruk";
//           content = "You are Daruk! A very ambitious individual who becoms wildly excitable when in battle. Although he is usually very calm, he becomes very loud and ferocious when fighting. He is very courageous when it comes protecting the ones you love and extremely strong!";
//           image_url = "../images/daruk-botw.png";
//           date = "March 21 – April 19"
//           audio_url = "/audios/daruk.mp3";
//         }});
//       });

/* Help Modal Start */
const openHelp = document.getElementById('open'); // Corrected variable name
const helpModalCont = document.getElementById('help_modal_cont'); // Corrected variable name
const closeHelp = document.getElementById('close'); // Corrected variable name

openHelp.addEventListener('click', () => { // Corrected variable name
  helpModalCont.classList.add('show');
});

closeHelp.addEventListener('click', () => { // Corrected variable name
  helpModalCont.classList.remove('show');
});

/* Breath of the Wild Characters Custom Modals */
const modal = document.getElementById("modal"); // Corrected variable name
const openBtns = document.querySelectorAll(".open-btn"); // Corrected variable name
const closeBtn = document.querySelector(".close-btn"); // Corrected variable name
...
openBtns.forEach(button => {
  button.addEventListener("click", () => {
      ...
      let name = "Default Name";
      let content = "Default content paragraph 1";
      let imageLink = "default-img-url.png";
      let date = "Default Date";
      let audioUrl = "";

      // Customization based on button IDs
      if (button.id === "daruk") { // Corrected button ID
          title = "Daruk";
          content = "You are Daruk! A very ambitious individual who becomes wildly excitable when in battle. Although he is usually very calm, he becomes very loud and ferocious when fighting. He is very courageous when it comes to protecting the ones you love and extremely strong!";
          imageLink = "images/daruk-botw.png"; // Corrected image URL
          date = "March 21 – April 19";
          audioUrl = "/audios/daruk.mp3";
      }
  });
});